...
//
import StationLocationsTableRow from './station-locations-table-row';

// ----------------------------------------------------------------------

export default function StationLocationsTable({
  table,
  locations = [],
  //
  handleDelete,
              ...
              {dataFiltered
                ...
                .map((row) => (
                  <StationLocationsTableRow
                    ...
                    onEditRow={() => router.push(paths.dashboard.station.locations.edit(row.id))}
                  />
                ))}
...
StationLocationsTable.propTypes = {
