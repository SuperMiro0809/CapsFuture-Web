...
export default function BottleCapsAuthCover() {
    
    const caps = [
        { Component: BottleCapPink, left: '360px', startDelay: 0, rotationDuration: 3600 },
        { Component: BottleCapGreen, left: '440px', startDelay: 1000, rotationDuration: 3600 },
        { Component: BottleCapBlue, left: '720px', startDelay: 2000, rotationDuration: 3600 },
        { Component: BottleCapYellow, left: '720px', startDelay: 3000, rotationDuration: 3600 },
    ];
